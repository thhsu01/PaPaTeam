...
│       ├── daluntouweishan-2025-09-29.js
│       ├── eweishan-2025-08-30.js
│       ├── daqitou-2025-06-15.js
│       ├── zhongzhengshan-2025-04-27.js
...
它檢查段落 id 與順序、共用區塊的掃載點有沒有放對（沒有人把導覽列、航點卡手寫回來）、
四個 `<h2>` 的主詞、`init` 的設定鍵是不是 `detail.js` 認得的、灰階是否誤用 slate、
